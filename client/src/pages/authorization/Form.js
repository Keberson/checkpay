...
function Form() {
    ...
    const submitForm = async (e) => {
        ...
        if (validEmail && validPassword) {
            try {
                const data = await request('/api/auth/auth', 'POST', {...form});
    ...
    return (
        <>
            {isLoading ?
                ...
                (<form className="authorization__form" onSubmit={submitForm}>
                    ...
                    <Link to="/forgot-pas" className="authorization__forgot-password">Forgot your password?</Link>
                    <input type="submit"
